...
Reference for the `browser-qa` skill — full `agent-browser` tool grammar, workflows, and security envelope. Loaded into context when `browser-qa` detects `agent-browser` on PATH.
